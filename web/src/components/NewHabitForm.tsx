...
export default function NewHabitForm() {
  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      />
      <label htmlFor="title" className="mt-5 font-semibold leading-tight">
        Qual a recorrência?
      </label>
      ...
      <div className="mt-3 flex flex-col gap-2  ">
        {availableWeekDays.map((weekDay, index) => {
          return (
            ...
            >
              <div className="h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:bg-green-500 transition-colors focus:outline-none group-focus:ring-2 group-focus:ring-green-700 group-focus:ring-offset-2 group-focus:ring-offset-zinc-900">
